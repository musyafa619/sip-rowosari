...
export default function ComplaintCard({ complaint, showNama = false, showAdminActions = false }) {
  ...
  return (
    <>
      <div className="border border-gray-200 rounded-md p-4 hover:border-gray-300 transition-colors">
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1 min-w-0">
            ...
            <h3 className="text-sm font-medium text-gray-900 mb-1">{complaint.judul}</h3>
